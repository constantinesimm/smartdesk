<template>
  <d-container fluid class="admin-content-container px-4 pb-4">
    ...
    <d-row no-gutters class="page-header py-4">
      ...
      <d-col class="d-flex">
        <d-button-group size="small" class="d-inline-flex ml-auto my-auto">
          <d-link tag="button" class="btn btn-white" :to="{ name: 'users-manage-list' }">
            <i class="material-icons">&#xE8EF;</i>
          </d-link>
          <d-link tag="button" class="btn btn-white" :to="{ name: 'users-manage-cards' }">
            <i class="material-icons">&#xE8F0;</i>
          </d-link>
        </d-button-group>
      </d-col>
    ...
    data() {
      return {
        ...
        clientTableOptions: {
          ...
          skin: 'file-manager file-manager-list table table-hover dataTable',
          ...
          headings: {
            name: function(h) { return '<h2>Title</h2>'}
          }
        },
