	...
	<div class="card">
		...
		<div class="card-content">
			...
			<div class="field login-button-field">
				<div class="control">
					<b-button type="is-primary" class="login-button" label="Login" expanded :loading="loginButton['loading']" :disabled="!(this.emailField['isValid'] && this.secretField['isValid'])"/>
				</div>
			</div>
		</div>
		<footer class="card-footer">
			<div class="field is-grouped auth-buttons-fields">
				<div class="control ">
					<b-button @click="showPasswordRestoreModal" type="is-text" class="has-text-primary" label="Forgot Password?" inverted outlined/>
					<b-button @click="showRegisterModal" type="is-text" class="has-text-primary" label="Register" inverted outlined/>
				</div>
			</div>
		</footer>
	</div>
