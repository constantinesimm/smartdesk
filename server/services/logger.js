...
const loggerOptions = {
    ...
    template: '"date > [:date[clf]]", "method > :method", "status > :status", "url > :url", "HTTP version > HTTP/:http-version", "request header > :req[header]", "response header > :res[header]", "referrer > :referrer", "user agent > :user-agent"'
};
